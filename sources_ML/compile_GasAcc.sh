...
gfortran  -O3 -finit-real=nan  -I../FKB/build/include -I../DNN_atmo/Modules -L../FKB/build/lib -o GasAcc_exe  units_sbr.o CORE.f90 boundary_conditions.o Gas_Acc_Rate_from_Disk.o  Timestep.o 
main_Formation.o ../DNN_atmo/Modules/dnn_atmo.o -lneural
